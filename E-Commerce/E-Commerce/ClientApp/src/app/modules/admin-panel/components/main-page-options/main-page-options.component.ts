...
export class MainPageOptionsComponent implements OnInit {
  ...
  emptyItem:ProductModel = {id:0,name:"",price:0,quantity:0,description:"",specification:"",productPhoto:""};
  ...
  submit()
  {
    ...
    this.adminService.postMainPageItem(model).subscribe(response=>console.log(response));
