...
namespace E_Commerce.Migrations
{
    ...
    [Migration("20210211011629_description-shoppingCart-save")]
    partial class descriptionshoppingCartsave
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("E_Commerce.Shared.Entities.MainPageItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("MainPageItems");
                });

            modelBuilder.Entity("E_Commerce.Shared.Entities.Order", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("E_Commerce.Shared.Entities.UserInformations", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("E_Commerce.Shared.Entities.Order", b =>
                {
                    ...
                    b.HasOne("E_Commerce.Shared.Entities.UserInformations", "UserInformations")
                        .WithMany()
            ...
            modelBuilder.Entity("E_Commerce.Shared.Entities.Product", b =>
                {
                    b.HasOne("E_Commerce.Shared.Entities.SubCategory", "SubCategory")
                        .WithMany()
